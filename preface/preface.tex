...
整理 \href{https://keras.io/zh/}{Keras: 基于 Python 的深度学习库 （PDF 版）} 的主要原因在于学习 \href{https://keras.io/zh/}{Keras} 深度学习库时方便\textbf{本地查阅}，最新PDF版本请访问: \url{https://github.com/Godblesswz/keras-docs-zh}。
...
The main reason of organizing PDF version based the \href{https://github.com/keras-team/keras-docs-zh}{Chinese Keras Markdown} is that it is easy to \textbf{read locally} when learning the Keras Deep Learning Library. For the latest PDF version, please visit \url{https://github.com/Godblesswz/keras-docs-zh}.
